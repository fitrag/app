<x-app-layout>
    <x-slot name="header">
        <div class="px-0">
            <h1 class="text-3xl font-serif font-bold text-gray-900 tracking-tight">Settings</h1>
            <p class="mt-1 text-base text-gray-600">Manage your blog configuration</p>
        </div>
    </x-slot>
    ...
    <div class="py-8 px-8">
        ...
        <form action="{{ route('admin.settings.update') }}" method="POST">
            ...
            <div class="bg-white rounded-xl border border-gray-100 overflow-hidden mb-6">
                <div class="border-b border-gray-200">
                    <nav class="flex space-x-8 px-8" aria-label="Tabs">
                        <button type="button" onclick="switchTab('general')" id="tab-general" class="tab-button border-b-2 border-gray-900 py-4 px-1 text-sm font-medium text-gray-900">
                            <div class="flex items-center">
                        ...
                        <button type="button" onclick="switchTab('hero')" id="tab-hero" class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button type="button" onclick="switchTab('seo')" id="tab-seo" class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button type="button" onclick="switchTab('monetization')" id="tab-monetization" class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-8">
                    ...
                    <div id="content-general" class="tab-content">
                        <h2 class="text-xl font-serif font-bold text-gray-900 mb-6">General Settings</h2>
                        <div class="space-y-6">
                            <!-- Site Title -->
                            <div>
                                ...
                                <input type="text" 
                                       name="site_title" 
                                       id="site_title" 
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('site_title') border-red-500 @enderror" 
                            ...
                            <div>
                                ...
                                <textarea name="site_description" 
                                          id="site_description" 
                                          rows="4" 
                                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent resize-none @error('site_description') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       min="1"
                                       max="100"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('posts_per_page') border-red-500 @enderror" 
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="footer_text" 
                                       id="footer_text" 
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('footer_text') border-red-500 @enderror" 
                    ...
                    <div id="content-hero" class="tab-content hidden">
                        <h2 class="text-xl font-serif font-bold text-gray-900 mb-6">Hero Section Settings</h2>
                        <div class="space-y-6">
                            <!-- Show Hero Section -->
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                <div>
                                    <label for="hero_show" class="text-sm font-medium text-gray-700">Show Hero Section</label>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="hero_title" 
                                       id="hero_title" 
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('hero_title') border-red-500 @enderror" 
                            ...
                            <div>
                                ...
                                <textarea name="hero_description" 
                                          id="hero_description" 
                                          rows="3" 
                                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent resize-none @error('hero_description') border-red-500 @enderror"
                    ...
                    <div id="content-seo" class="tab-content hidden">
                        <h2 class="text-xl font-serif font-bold text-gray-900 mb-6">SEO Settings</h2>
                        <div class="space-y-6">
                            <!-- Meta Keywords -->
                            <div>
                                ...
                                <input type="text" 
                                       name="site_keywords" 
                                       id="site_keywords" 
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('site_keywords') border-red-500 @enderror" 
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <!-- Meta Author -->
                                <div>
                                    <label for="meta_author" class="block text-sm font-medium text-gray-700 mb-2">
                                        Meta Author
                                    </label>
                                    <input type="text" 
                                           name="meta_author" 
                                           id="meta_author" 
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('meta_author') border-red-500 @enderror" 
                                ...
                                <!-- OG Image -->
                                <div>
                                    <label for="meta_og_image" class="block text-sm font-medium text-gray-700 mb-2">
                                        Open Graph Image
                                    </label>
                                    <input type="url" 
                                           name="meta_og_image" 
                                           id="meta_og_image" 
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('meta_og_image') border-red-500 @enderror" 
                    ...
                    <div id="content-monetization" class="tab-content hidden">
                        <h2 class="text-xl font-serif font-bold text-gray-900 mb-6">Monetization Settings</h2>
                        <div class="space-y-6">
                            <!-- Coins Per Post -->
                            <div>
                                <label for="coins_per_post" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <input type="number" 
                                       ...
                                       min="0"
                                       step="0.01"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('coins_per_post') border-red-500 @enderror" 
                            ...
                            <div>
                                <label for="coins_per_1000_views" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <input type="number" 
                                       ...
                                       min="0"
                                       step="0.01"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('coins_per_1000_views') border-red-500 @enderror" 
                            ...
                            <div>
                                <label for="monetization_min_posts" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <input type="number" 
                                       ...
                                       min="0"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('monetization_min_posts') border-red-500 @enderror" 
                            ...
                            <div>
                                <label for="monetization_min_views" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <input type="number" 
                                       ...
                                       min="0"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent @error('monetization_min_views') border-red-500 @enderror" 
                            ...
                            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                <div class="flex">
                                    ...
                                    <div class="text-sm text-yellow-800">
                                        <p class="font-semibold mb-1">Monetization Requirements</p>
                                        <p>These settings determine when editors can apply for monetization. Editors must meet both the minimum posts and views requirements.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex items-center justify-end space-x-4">
                ...
                <button type="submit" class="inline-flex items-center px-8 py-3 bg-gray-900 text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
