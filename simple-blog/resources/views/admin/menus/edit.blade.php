            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-200">
                <form action="{{ route('admin.menus.update', $menu) }}" method="POST" class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="label" id="label" value="{{ old('label', $menu->label) }}" required
                    ...
                    <div class="mb-6">
                        ...
                        <select name="location" id="location" 
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent">
                            <option value="public" {{ old('location', $menu->location) == 'public' ? 'selected' : '' }}>Public (Frontend)</option>
                            <option value="admin" {{ old('location', $menu->location) == 'admin' ? 'selected' : '' }}>Admin (Backend)</option>
                        </select>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-xs text-gray-500">Select a parent menu to make this a submenu (dropdown)</p>
                        @error('parent_id')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
