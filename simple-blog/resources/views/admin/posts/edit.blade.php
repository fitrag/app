                            ...
                            <div class="p-6">
                                <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">{{ $post->image ? 'Replace cover image' : 'Add a cover image' }}</p>
                                    </div>
                                </div>
                        ...
                        <div class="bg-white rounded-xl border border-gray-100 overflow-hidden transition-shadow duration-200 hover:shadow-sm">
                            <div class="p-6">
                                ...
                                <textarea name="content" 
                                          ...
                                          placeholder="Start writing your story...">{{ old('content', $post->content) }}</textarea>
                        ...
                        <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                            ...
                            <div class="flex items-center mb-4">
                                <input type="checkbox" 
                                       ...
                                       class="h-4 w-4 text-gray-900 focus:ring-gray-900 border-gray-300 rounded" 
                                       value="1" 
                                       {{ old('enable_font_adjuster', $post->enable_font_adjuster) ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center mb-4">
                                <input type="checkbox" 
                                       ...
                                       class="h-4 w-4 text-gray-900 focus:ring-gray-900 border-gray-300 rounded" 
                                       value="1" 
                                       {{ old('show_read_also', $post->show_read_also) ? 'checked' : '' }}>
    ...
    <script>
        ClassicEditor
            ...
            .then(editor => {
                ...
                let currentDraftId = {{ $post->id }}; // Track current post ID for updates
                ...
                function updateSaveStatus(status, message = '') {
                    ...
                    switch(status) {
                        ...
                        case 'restored':
                            iconSvg.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>';
                            iconSvg.className = 'w-3.5 h-3.5 text-blue-500';
                            textSpan.className = 'text-blue-600';
                            textSpan.textContent = 'Draft restored';
                            break;
                        default:
                            iconSvg.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>';
                ...
                function saveDraft() {
                    try {
                        ...
                        const formData = {
                            id: currentDraftId, // Post ID for update
