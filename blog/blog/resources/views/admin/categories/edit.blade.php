...
@section('subtitle', 'Perbarui informasi kategori')
...
<div style="max-width: 600px;">
    <div style="margin-bottom: 30px;">
        <h1 style="font-size: 28px; font-weight: 700; color: #1e293b; margin-bottom: 5px;">Edit Kategori</h1>
        <p style="color: #64748b; font-size: 14px;">Perbarui informasi kategori untuk mengorganisir artikel Anda</p>
    </div>
        ...
        <form action="{{ route('categories.update', $category) }}" method="POST">
            ...
            <div style="background: #f8fafc; border-radius: 12px; padding: 20px; margin-bottom: 25px; border-left: 4px solid #667eea;">
                <div style="display: flex; align-items: center; gap: 12px;">
                    <i class="fas fa-info-circle" style="color: #667eea; font-size: 16px;"></i>
                    <div>
                        <div style="font-weight: 600; color: #1e293b; font-size: 14px;">Informasi</div>
                        <div style="color: #64748b; font-size: 13px; margin-top: 2px;">Slug akan diperbarui otomatis berdasarkan nama kategori</div>
                    </div>
                </div>
            </div>
